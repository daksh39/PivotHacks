...
-- --- §07 starter set -------------------------------------------------------
-- 37 categories, matching proxy/categories.ts one for one.
...
('phone','check','["Ask for the battery health percentage.","Confirm it is not carrier-locked or activation-locked.","Check the IMEI is not blacklisted before paying."]',
  55,'Published smartphone LCAs — ~55 kg CO2e manufacturing, 85-95% of lifetime footprint','Manufacturing is almost the entire footprint of a phone, so a used one avoids nearly all of it.',FALSE),
